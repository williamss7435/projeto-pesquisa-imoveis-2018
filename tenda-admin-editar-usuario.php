...
<body>
            ...
            <div class="col-lg-2 menu-flex menu-left">
                <nav class="nav flex-column pb-5">
                    ...
                    <div class="collapse mb-3" id="menu-usuario">
                        ...
                        <a href="tenda-admin-editar-usuario.php" class="nav-link bg-primary"><span class="oi oi-pencil"></span> Resetar / Excluir</a>
                    </div>      
                  ...
                  <div class="row mt-3 mb-3">
                     <div class="col-12 col-lg-7">    
                      <div class="input-group mb-3">
                        <input type="text" class="form-control" placeholder="Pesquisar Por E-mail Ou Nome" id="inputSeach">
   ...
   <div class="modal fade" id="modal-dados" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <script src="_comp/bootstrap/js/bootstrap.min.js"></script>
     ...
     <script src="_js/reseta-excluir.js"></script>
</body>
</html>