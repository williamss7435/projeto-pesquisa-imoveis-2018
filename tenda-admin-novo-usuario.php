...
<body>
        ...
        <div class="row">
            <div class="col-lg-2 menu-flex menu-left">
                <nav class="nav flex-column pb-5">
                    ...
                    <a class="nav-link mt-3 bg-primary" data-toggle="collapse" href="#menu-usuario" role="button" aria-expanded="false" aria-controls="collapseExample">Usuários <span class="oi oi-chevron-right float-right"></span></a>
                    <div class="collapse mb-3" id="menu-usuario">
                        <a href="tenda-admin-novo-usuario.php" class="nav-link bg-primary"> <span class="oi oi-plus"></span> Cadastrar Usuário</a>
            ...
            <div class="col-12 col-lg-10 m-6">
                 <div class="col-12 col-lg-8 form-register mx-auto d-block">
                   <form id="form-new-user" class="mt-3">

                     <div class="row">
                        <div class="col text-center title-register">
                          <span class="oi oi-person"></span><span class="d-none d-sm-block"> Cadastrar Novo Imóvel</span>
                        </div>
                     </div>

                    <div class="form-group mt-3">
                      <label for="NewUserName">Nome Do Usuario</label>
                      <input type="text" class="form-control" id="newUserName" name="newUserName" required>
                    </div>

                    <div class="form-group mt-3">
                      <label for="newUserLastName">Sobrenome</label>
                      <input type="text" class="form-control" id="newUserLastName" name="newUserLastName" required>
                    </div>
                    ...
                    <div class="form-group mt-3">
                      <label for="newUserOffice">Nome Do Responsável</label>
                      <input type="text" class="form-control" id="newUserOffice" name="newUserOffice" required>
                    </div>
                    
                    <div class="col">
                          <label class="mr-sm-2" for="newUserSetor">Área</label>
                          <select class="custom-select mr-sm-2" id="newUserSetor" name="newUserSetor" required>
                            <option selected value="">Escolher...</option>
                            <option value="1">Telemarketing</option>
                            <option value="2">Chat</option>
                            <option value="3">Venda (Corretor)</option>
                     ...
                     <div class="row">
                      <div class="col mb-2">
                        <button class="btn btn-lg btn-success form-control mb-4 mt-5" type="submit">Cadastrar Usuário</button>
                      </div>
                    </div>
   ...
   <div class="modal fade" id="modal-dados" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <script src="_js/novo-usuario.js"></script>
